...
const cite = () => {
    ...
    if (citation_format.value == 'mla8') {
        cite = new MLA8(authors, title, website_title, publisher, url, date_published, date_accessed);
    }
    else if (citation_format.value == 'apa7') {
        cite = new APA7(authors, title, website_title, publisher, url, date_published, date_accessed);
    }
    else {
